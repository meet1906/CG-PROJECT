// Developing and Illustration of  Catch the Ball game using OPENGL  as a part of CG PROJ - 6TH SEM
// A PROJECT BY MEET SHAH - 1PE17CS084 AND KRISHNA AGARWAL - 1PE17CS073
#include<stdio.h> 
#include<GL/glut.h> 
#include<math.h> 
#define pi 3.142857 
//pi as we use circle
// Global Declaration of variables that shall be used throughout 
// c and d tracks the number of time 'b' and 'n' pressed respectively 
//'b' means going left and 'n'is used  go right
...
void myInit (void) 
{ 
	// Reset background color with YELLOW (1,1,0 - yellow if you want black then 0,0,0 and if you want yellow then all three should be 1.0) 
